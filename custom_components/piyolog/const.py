...
SERVICE_ADD_HEIGHT = "add_height"
SERVICE_ADD_TEMPERATURE = "add_temperature"
SERVICE_ADD_HEAD_CIRCUMFERENCE = "add_head_circumference"
SERVICE_ADD_CHEST_CIRCUMFERENCE = "add_chest_circumference"
